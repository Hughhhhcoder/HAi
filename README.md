...
- 🤖 **AI 专业报告自动生成**：每次测评后自动生成详细的心理评估报告（基于 DSM-5/ICD-11 标准）
- 🔄 **测评结果实时同步画像**：测评完成后自动更新用户画像，AI 对话实时感知用户最新心理状态
- 🖼️ **多模态支持**：支持图片上传（最大 50MB）和识别
- 📊 **专业心理测评**：10 个国际标准量表（完整版192题），覆盖情绪、人际、自我认知、职场、创伤等 5 大领域
- 📝 **每日打卡**：记录心情和睡眠，积分激励
...
- 心理测评分类：`GET /psych/categories` → 返回 5 大分类和 10 个量表（完整版192题）
- 心理问卷：`GET /psych/questionnaire?test_type=PHQ9` 或 `PSS14`、`ECR36`、`IRI28`、`SCS26`、`MBI22`、`PCL5_20` 等
- 打卡：`POST /checkin/daily`

前端提供 `ApiTest` 页面便于快速验证。

## 心理测评系统（10 个专业量表 - 完整版192题）

**重要说明**：所有量表均采用国际标准完整版本，而非简化版，确保最高的专业性和准确性。

### 🔵 情绪与心境类 (4个，50题)
- **PHQ-9** - 抑郁自评量表（完整版9题）
- **GAD-7** - 焦虑自评量表（完整版7题）
- **PSS-14** - 压力知觉量表（完整版14题，含反向计分）
- **PANAS** - 积极消极情绪量表（完整版20题，双维度评估）

### 🟣 人际关系类 (2个，64题)
- **ECR-36** - 亲密关系体验量表（完整版36题，评估依恋风格的焦虑和回避两个维度）
- **IRI-28** - 人际反应指数（完整版28题，评估观点采择、幻想、共情关注、个人痛苦四个维度）

### 🟢 自我认知类 (2个，36题)
- **RSES** - 罗森伯格自尊量表（完整版10题）
- **SCS-26** - 自我同情量表（完整版26题，评估自我友善、自我批判、普遍人性、孤立、正念、过度认同六个维度）

### 🟠 职场与学业类 (1个，22题)
- **MBI-22** - 职业倦怠量表（完整版22题，评估情绪耗竭、去人格化、个人成就感三个维度）

### 🔴 创伤与应激类 (1个，20题)
- **PCL-5** - PTSD 检查表（完整版20题，符合 DSM-5 诊断标准，评估侵入、回避、认知情绪负性改变、警觉性改变四个症状簇）

### 📊 量表统计
- **总题目数**：192题（完整版）
- **总测评时间**：约60-90分钟（全部完成）
- **单个量表**：2-12分钟不等
- **信效度**：所有量表均为国际公认的标准化工具，经过严格的信效度验证
