  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <!-- 文献资料 -->
        <router-link to="/literature/list" class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <h3 class="text-center font-semibold text-gray-800 mb-2">文献资料</h3>
          <p class="text-center text-sm text-gray-600">专业文献检索</p>
        </router-link>
